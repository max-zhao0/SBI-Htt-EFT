...
# with command line options: --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring --step PAT --geometry DB:Extended --conditions 150X_mcRun3_2024_realistic_v2 --datatier MINIAODSIM --eventcontent MINIAODSIM1 --python_filename VBF_Htt_SMEFTsim_topU3l_quadratic_miniaodsim_cfg.py --filein file:aodsim.root --fileout file:miniaodsim.root --nThreads 8 --number 200 --number_out 200 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--era nevts:200'),
