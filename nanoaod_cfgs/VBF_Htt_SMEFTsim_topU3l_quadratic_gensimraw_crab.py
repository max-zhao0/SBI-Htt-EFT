...
config.General.requestName     = 'VBF_Htt_SMEFTsim_topU3l_quadratic_gensimraw_5mevents'
...
config.Data.userInputFiles = [
    "root://cmseos.fnal.gov//store/group/lpchiggssbi/signal/VBFHtoTauTau/140X_mcRun3_2024_realistic_v26/gensim_v2/0000/gensim_{}.root".format(i) for i in range(1, config.Data.totalUnits + 1)
]
