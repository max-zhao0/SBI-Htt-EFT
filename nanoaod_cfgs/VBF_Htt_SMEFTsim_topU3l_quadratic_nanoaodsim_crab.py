...
config.General.requestName     = 'VBF_Htt_SMEFTsim_topU3l_quadratic_unpolarized_nanoaodsim_200kevents'
...
config.Data.userInputFiles = [
    "root://eosuser.cern.ch//eos/user/z/zhaom/qqHtoTauTau/140X_mcRun3_2024_realistic_v26/miniaodsim_v1/0000/miniaodsim_{}.root".format(i) for i in range(1, 6)
]
