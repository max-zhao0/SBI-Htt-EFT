...
config.General.requestName     = 'VBF_Htt_SMEFTsim_topU3l_quadratic_unpolarized_aodsim_200kevents'
...
config.Data.userInputFiles = [
    "root://eosuser.cern.ch//eos/user/z/zhaom/qqHtoTauTau/140X_mcRun3_2024_realistic_v26/gensimraw_v1/0000/gensimraw_{}.root".format(i) for i in range(1, 21)
]
