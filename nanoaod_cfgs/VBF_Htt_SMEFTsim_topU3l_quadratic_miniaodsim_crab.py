...
config.General.requestName     = 'VBF_Htt_SMEFTsim_topU3l_quadratic_np0_miniaodsim'
...
config.Data.userInputFiles = [
    "root://eosuser.cern.ch//eos/user/z/zhaom/qqHtoTauTau/140X_mcRun3_2024_realistic_v26/aodsim_np0/0000/aodsim_{}.root".format(i) for i in range(1, config.Data.totalUnits + 1)
]
